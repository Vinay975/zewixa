      ...
      >
        ...
        <View style={styles.ownerInfo}>
          ...
          {hostel.owner?.phoneTwo && (
            <Text style={styles.ownerPhone}>
              <Ionicons name="call-outline" size={16} /> {hostel.owner.phoneTwo}
            </Text>
          )}
          ...
          <Text style={styles.ownerEmail}>
            ...
            {hostel.owner?.email || "Email not available"}
          </Text>
        </View>
      </Animatable.View>
        ...
        <View style={styles.rentGrid}>
          ...
          {hostel.rent?.ThreeSharing && (
            <View style={styles.rentItem}>
              ...
              <Text style={styles.rentText}>
                Triple: ₹{hostel.rent.ThreeSharing}
              </Text>
            </View>
          )}
